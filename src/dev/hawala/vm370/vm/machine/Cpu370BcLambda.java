...
/**
 * First Java8-compatible implementation of S/370 instructions using
 * function pointers.
 * <br/>
 * The function interface defines the {@code execute()} method passing
 * the next 5 code bytes (following the instruction byte itself), so
 * the function implementing an instruction needs not to fetch any of the
 * required opcode bytes.
 * <br/>
 ...
 */
public class Cpu370BcLambda extends Cpu370Bc {
	...
	public interface Instr370 {
		 ...
		 * 		this instruction)
		 * @param ib3
		 * 		second byte following the instruction byte
		 * @param ib4
		 * 		third byte following the instruction byte
		 * @param ib5
		 * 		fourth byte following the instruction byte
		 * @param ib6
		 * 		fifth byte following the instruction byte
		 * @param updPSW
		 ...
		 */
		public int execute(byte ib2, byte ib3, byte ib4, byte ib5, byte ib6, boolean updPSW) throws PSWException;
	 ...
	 */
	private Instr370 invInstr = (i2, i3, i4, i5, i6, updPSW) -> EXECSTATE_UNKNOWN_INSTRUCTION;
	...
	private Instr370 tmplRR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x04_SPM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int op1 = this.gpr[r1];
	...
	private Instr370 x05_BALR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	private Instr370 x06_BCTR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x07_BCR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	// SSK - Set Storage Key
	private Instr370 x08_SSK = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
	...
	private Instr370 x09_ISK = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	// SVC - Supervisor call
	private Instr370 x0A_SVC = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {		
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 2;
			this.pswInstructionLengthCode = 1;
		...
		if (INSNS_LOG) {
			if (ib2 == (byte)0xCA) { this.dumpSVC202(); }
		}
	...
	private Instr370 x0B_BSM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {		
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 2;
			this.pswInstructionLengthCode = 1;
	...
	// 31-bit capable software
	// => tell the program that this is "old" hardware 
	private Instr370 x0C_BASSM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {		
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 2;
			this.pswInstructionLengthCode = 1;
	...
	private Instr370 x0D_BASM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 2;
			this.pswInstructionLengthCode = 1;
	...
	private Instr370 x0E_MVCL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
	...
	private Instr370 x0F_CLCL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
	...
	// LPR - Load positive
	private Instr370 x10_LPR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	// LNR - Load negative
	private Instr370 x11_LNR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	private Instr370 x12_LTR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	private Instr370 x13_LCR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	// NR - And registers
	private Instr370 x14_NR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x15_CLR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	// OR - Or registers
	private Instr370 x16_OR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x17_XR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	// LR - Load register
	private Instr370 x18_LR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	private Instr370 x19_CR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	// AR - Add registers
	private Instr370 x1A_AR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x1B_SR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x1C_MR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	// DR - Divide Registers
	private Instr370 x1D_DR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x1E_ALR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x1F_SLR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	@SuppressWarnings("unused")
	private Instr370 tmplRX = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// STH - Store halfword
	private Instr370 x40_STH = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// LA - Load address
	private Instr370 x41_LA = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// STC - Store character
	private Instr370 x42_STC = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
		...
		if (INSNS_LOG) {
			this.logInfo("     => [0x%06X] <- 0x%02X", addr2, op1);
		} 
	...
	// IC - Insert character
	private Instr370 x43_IC = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// EX - Execute
	private Instr370 x44_EX = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// BAL - Branch and link
	private Instr370 x45_BAL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// BCT - Branch on count
	private Instr370 x46_BCT = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	private Instr370 x47_BC = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// LH - Load halfword
	private Instr370 x48_LH = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// CH - Compare halfword
	private Instr370 x49_CH = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
		...
		this.pswConditionCode = (op1 < op2) ? CC1 : (op1 > op2) ? CC2 : CC0;
		if (INSNS_LOG) {
			this.logInfo("     => r = 0x%04X <=> [0x%06X] = 0x%04X", op1, addr2, op2);
			this.logInfo("     => CC <- %d", this.pswConditionCode);
		}
		return 0; // ok
	};
	
	// AH - Add halfword
	private Instr370 x4A_AH = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	private Instr370 x4B_SH = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	private Instr370 x4C_MH = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// 31-bit capable software
	// => tell the program that this is "old" hardware 
	private Instr370 x4D_BAS = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	private Instr370 x4E_CVD = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	private Instr370 x4F_CVB = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// ST - Store
	private Instr370 x50_ST = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// N - And
	private Instr370 x54_N = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// CL - Compare logical
	private Instr370 x55_CL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// O - Or
	private Instr370 x56_O = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// X - Exclusive or
	private Instr370 x57_X = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// L - Load
	private Instr370 x58_L = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
		...
		int op2 = ((this.mem[addr2]&0xFF)<<24) | ((this.mem[addr2+1]&0xFF)<<16) | ((this.mem[addr2+2]&0xFF)<<8) | (this.mem[addr2+3]&0xFF);
		if (INSNS_LOG) {
			this.logInfo("      => r%d <- 0x%08X", r1, op2);
		}
		this.gpr[r1] = op2;
		return 0; // ok
	};
	...
	// C - Compare
	private Instr370 x59_C = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
		...
		this.pswConditionCode = (op1 < op2) ? CC1 : (op1 > op2) ? CC2 : CC0;
		if (INSNS_LOG) {
			this.logInfo("     => r%d=0x%08X <-> [addr2]=0x%08X", r1, op1, op2);
			this.logInfo("     => CC = %d", this.pswConditionCode);
		}
		return 0; // ok
	};
	...
	// A - Add
	private Instr370 x5A_A = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// S - Substract
	private Instr370 x5B_S = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// M - Multiply
	private Instr370 x5C_M = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// D - Divide
	private Instr370 x5D_D = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// AL - Add logical
	private Instr370 x5E_AL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	private Instr370 x5F_SL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	@SuppressWarnings("unused")
	private Instr370 tmplRS = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	private Instr370 x80_SSM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	private Instr370 x82_LPSW = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
		...
		if (INSNS_LOG) {
			this.logInfo("---> new PSW: %02X%02X%02X%02X %02X%02X%02X%02X", this.mem[addr2], this.mem[addr2+1], this.mem[addr2+2], this.mem[addr2+3], this.mem[addr2+4], this.mem[addr2+5], this.mem[addr2+6], this.mem[addr2+7]);
		}
...
//		if (INSNS_LOG) { this.checkSVC202end(); }
	...
	private Instr370 x86_BXH = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	private Instr370 x87_BXLE = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	private Instr370 x88_SRL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	private Instr370 x89_SLL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	private Instr370 x8A_SRA = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	private Instr370 x8B_SLA = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	private Instr370 x8C_SRDL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	private Instr370 x8D_SLDL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	private Instr370 x8E_SRDA = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	private Instr370 x8F_SLDA = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	// STM - Store Multiple
	private Instr370 x90_STM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		...
		while(true) {
			...
			if (INSNS_LOG) {
				this.logInfo("     => [0x%06X] <- 0x%08X", addr2, val);
			}
	...
	// LM - Load multiple
	private Instr370 x98_LM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		...
		while(true) {
			...
			if (INSNS_LOG) {
				this.logInfo("      => r%d <- %08X", curr, this.gpr[curr]);
			}
	...
	private Instr370 xB2_PrivInstr = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	// CS - Compare and swap
	private Instr370 xBA_CS = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	private Instr370 xBB_CDS = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	private Instr370 xBD_CLM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		...
		if ((r3 & 0x08) != 0) { 
		    ...
		    if (op1 != op2) {
		    	this.pswConditionCode = (op1 < op2) ? CC1: CC2;
				if (INSNS_LOG) {
					this.logInfo("      => CC = %d (1000: op1 = %02X ; op2 = %02X)", this.pswConditionCode, op1, op2);
					this.logInfo("      =>         (1000: op1 = op2 = %02X)", this.pswConditionCode, op1, op2);
				}
				return 0; // ok
		    }
		    if (INSNS_LOG) {
		    	this.logInfo("      =>         (1000: op1 = op2 = %02X)", op2);
		    }
		}
		if ((r3 & 0x04) != 0) { 
			op1 = (opr1 >> 16) & 0xFF;
		    ...
		    if (op1 != op2) {
		    	this.pswConditionCode = (op1 < op2) ? CC1: CC2;
		    	if (INSNS_LOG) {
					this.logInfo("      => CC = %d (0100: op1 = %02X ; op2 = %02X)", this.pswConditionCode, op1, op2);
				}
				return 0; // ok
		    }
		    if (INSNS_LOG) {
		    	this.logInfo("      =>         (0100: op1 = op2 = %02X)", op2);
		    }
		}
		if ((r3 & 0x02) != 0) { 
			op1 = (opr1 >> 8) & 0xFF;
		    ...
		    if (op1 != op2) {
		    	this.pswConditionCode = (op1 < op2) ? CC1: CC2;
		    	if (INSNS_LOG) {
					this.logInfo("      => CC = %d (0010: op1 = %02X ; op2 = %02X)", this.pswConditionCode, op1, op2);
				}
				return 0; // ok
		    }
		    if (INSNS_LOG) {
		    	this.logInfo("      =>         (0010: op1 = op2 = %02X)", op2);
		    }
		}
		if ((r3 & 0x01) != 0) { 
			op1 = opr1 & 0xFF;
		    ...
		    if (op1 != op2) {
		    	this.pswConditionCode = (op1 < op2) ? CC1: CC2;
		    	if (INSNS_LOG) {
					this.logInfo("      => CC = %d (0001: op1 = %02X ; op2 = %02X)", this.pswConditionCode, op1, op2);
				}
				return 0; // ok
		    }
		    if (INSNS_LOG) {
		    	this.logInfo("      =>         (0001: op1 = op2 = %02X)", op2);
		    }
		}
	...
	private Instr370 xBE_STCM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		...
		if (INSNS_LOG) {
			int at = addr2;
			int v = this.gpr[r1];
			if ((r3 & 0x08) != 0) { this.logInfo("     => [0x%06X] <- 0x%02X", at++, (byte)((v >> 24) & 0xFF)); }
			if ((r3 & 0x04) != 0) { this.logInfo("     => [0x%06X] <- 0x%02X", at++, (byte)((v >> 16) & 0xFF)); }
			if ((r3 & 0x02) != 0) { this.logInfo("     => [0x%06X] <- 0x%02X", at++, (byte)((v >> 8) & 0xFF)); }
			if ((r3 & 0x01) != 0) { this.logInfo("     => [0x%06X] <- 0x%02X", at++, (byte)(v) & 0xFF); }
		}
	...
	private Instr370 xBF_ICM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		...
		if (INSNS_LOG) {
			this.logInfo("     => r%d <- 0x%08X", r1, val);
			this.logInfo("     => CC  <- %d", this.pswConditionCode);
		}
		return 0; // ok
	};
	...
	@SuppressWarnings("unused")
	private Instr370 tmplSI = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int i2 = ib2 & 0xFF;
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0xFF);
	...
	// TM - Test under Mask
	private Instr370 x91_TM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int i2 = ib2 & 0xFF;
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0xFF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
		...
		if (INSNS_LOG) {
			this.logInfo("     => [%06X]=0x%02X & 0x%02X -> 0x%02X", addr1, this.mem[addr1]&0xFF, i2, testedBits);
			this.logInfo("     => CC <- %d", this.pswConditionCode);
		}
		return 0; // ok
	};
	...
	// MVI - Move immediate
	private Instr370 x92_MVI = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int i2 = ib2 & 0xFF;
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0xFF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
		...
		if (INSNS_LOG) {
			this.logInfo("     => [0x%06X] <- %d", addr1, i2);
		}
	...
	// TS - Test and set
	private Instr370 x93_TS = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0xFF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	// NI - And immediate
	private Instr370 x94_NI = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int i2 = ib2 & 0xFF;
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0xFF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
		...
		this.pswConditionCode = (res == 0) ? CC0 : CC1;
		if (INSNS_LOG) {
			this.logInfo("     => [0x%06X] <- 0x%02X (op1=0x%02X & i2=0x%02X)", addr1, res, op1, i2);
			this.logInfo("     => CC = %d", this.pswConditionCode);
		}
		return 0; // ok
	};
	...
	private Instr370 x95_CLI = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int i2 = ib2 & 0xFF;
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0xFF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
		...
		if (INSNS_LOG) {
			this.logInfo("      => CC = %d (op1 = %02X ; i2 = %02X)", this.pswConditionCode, op1, i2);
		}
		return 0; // ok
	};
	
	// OI - Or immediate
	private Instr370 x96_OI = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int i2 = ib2 & 0xFF;
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0xFF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	private Instr370 x97_XI = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int i2 = ib2 & 0xFF;
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0xFF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	private Instr370 xAC_STNSM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int i2 = ib2 & 0xFF;
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0xFF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	private Instr370 xAD_STOSM = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int i2 = ib2 & 0xFF;
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0xFF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	@SuppressWarnings("unused")
	private Instr370 tmplSS = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
		int b2 = (ib5 & 0xF0) >> 4;
		int ddd2 = ((ib5 & 0x0F) << 8) + (ib6 & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	// MVN - Move numerics
	private Instr370 xD1_MVN = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	// MVC - Move characters
	private Instr370 xD2_MVC = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	// MVZ - Move zones
	private Instr370 xD3_MVZ = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	// NC - And characters
	private Instr370 xD4_NC = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	private Instr370 xD5_CLC = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
		...
		while(ll-- > 0) {
			...
			op2 = this.mem[addr2++] & 0xFF;
			if (INSNS_LOG) {
				this.logInfo("     => [0x%06X]=0x%02X <-> [0x%06X]=0x%02X", addr1-1, op1, addr2-1, op2);
			}
			if (op1 == op2) { continue; }
			this.pswConditionCode = (op1 < op2) ? CC1 : CC2;
			if (INSNS_LOG) {
	...
	// OC - Or characters
	private Instr370 xD6_OC = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	private Instr370 xD7_XC = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
		...
		while(ll-- > 0) {
			...
			res = op1 ^ op2;
			if (INSNS_LOG) {
				this.logInfo("     => [0x%06X] <- 0x%02X", addr1, res);
			}
			this.mem[addr1++] = (byte)res;
			if (res != 0) { this.pswConditionCode = CC1; }
		}
	...
	// TR - Translate
	private Instr370 xDC_TR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	private Instr370 xDD_TRT = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	// ED - Edit
	private Instr370 xDE_ED = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	// EDMK - Edit and mark
	private Instr370 xDF_EDMK = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
	...
	private Instr370 xF0_SRP = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	private Instr370 xF1_MVO = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	// PACK - Pack
	private Instr370 xF2_PACK = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	// UNPK - Unpack
	private Instr370 xF3_UNPK = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	// ZAP - Zero add packed
	private Instr370 xF8_ZAP = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	private Instr370 xF9_CP = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	private Instr370 xFA_AP = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	private Instr370 xFB_SP = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	private Instr370 xFC_MP = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	// DP - Divide packed
	private Instr370 xFD_DP = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) + (ib4 & 0x00FF);
	...
	private Instr370 x20_LPDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
	...
	private Instr370 x21_LNDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			f1.isPositive = false;
	...
	private Instr370 x22_LTDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
	...
	private Instr370 x23_LCDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
	...
	// HDR - HALVE (long)
	private Instr370 x24_HDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.halveFrom(f2);
	...
	private Instr370 x25_LRDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installe
		});
	
	// MXR - MULTIPLY (extended)
	private Instr370 x26_MXR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installed
		});
	
	// MXDR - MULTIPLY (long to extended)
	private Instr370 x27_MXDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installed
		});
	
	// LDR - LOAD (long)
	private Instr370 x28_LDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			return oldCC;
		});
	...
	// CDR - COMPARE (long)
	private Instr370 x29_CDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return FloatImpl.CMP2CC[f1.compareWith(f2) + 1];
		});
	
	// ADR - ADD NORMALIZED (long)
	private Instr370 x2A_ADR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
	...
	private Instr370 x2B_SDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
	...
	// MDR - MULTIPLY (long)
	private Instr370 x2C_MDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.multiply(f2);
			return FloatImpl.generateResult(oldCC, f1, allowUnderflow, allowSignificance);
	...
	// DDR - DIVIDE (long)
	private Instr370 x2D_DDR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
	...
	private Instr370 x2E_AWR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, false);
	...
	private Instr370 x2F_SWR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, true);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), false, allowSignificance);
	...
	private Instr370 x30_LPER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			f1.isPositive = true;
			return (f1.isZero) ? 0 : 2;
	...
	private Instr370 x31_LNER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			f1.isPositive = false;
			return (f1.isZero) ? 0 : 1;
	...
	private Instr370 x32_LTER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), allowUnderflow, allowSignificance);
		});
	...
	private Instr370 x33_LCER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			f1.isPositive = !f1.isPositive;
			return FloatImpl.generateResult(oldCC, f1, f1.test(), allowUnderflow, false);
	...
	// HER - HALVE (short)
	private Instr370 x34_HER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.halveFrom(f2);
			return FloatImpl.generateResult(oldCC, f1, allowUnderflow, allowSignificance);
		});
	...
	private Instr370 x35_LRER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.roundToShort();
	...
	private Instr370 x36_AXR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installed
		});
	
	// SXR - SUBTRACT NORMALIZED (extended)
	private Instr370 x37_SXR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installed
		});
	
	// LER - LOAD (short)
	private Instr370 x38_LER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			return oldCC;
		});
	...
	// CER - COMPARE (short)
	private Instr370 x39_CER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return FloatImpl.CMP2CC[f1.compareWith(f2) + 1];
		});
	
	// AER - ADD NORMALIZED (short)
	private Instr370 x3A_AER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, false);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), allowUnderflow, allowSignificance);
	...
	private Instr370 x3B_SER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, true);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), allowUnderflow, allowSignificance);
	...
	private Instr370 x3C_MER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.multiply(f2);
			return FloatImpl.generateResult(oldCC, f1, allowUnderflow, allowSignificance);
	...
	// DER - DIVIDE (short)
	private Instr370 x3D_DER = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			if (f2.isZero) { return INTR_PGM_FLOAT_DIVIDE; }
			allowSignificance &= f1.isZero;
			f1.divide(f2);
	...
	private Instr370 x3E_AUR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, false);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), false, allowSignificance);
	...
	private Instr370 x3F_SUR = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, true);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), false, allowSignificance);
	...
	private int fpRX(byte ib2, byte ib3, byte ib4, boolean updPSW, FpRXCode code) throws PSWException {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (ib4 & 0x00FF);
	...
	// STD - STORE (long)
	private Instr370 x60_STD = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
	...
	private Instr370 x67_XD = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installed
		});
	
	// LD - LOAD (long)
	private Instr370 x68_LD = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
	...
	// CD - COMPARE (long)
	private Instr370 x69_CD = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
	...
	private Instr370 x6A_AD = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
			allowSignificance &= f1.isZero;
	...
	private Instr370 x6B_SD = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
			allowSignificance &= f1.isZero;
	...
	// MD - MULTIPLY (long)
	private Instr370 x6C_MD = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
			allowSignificance &= f1.isZero;
	...
	// DD - DIVIDE (long)
	private Instr370 x6D_DD = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
	...
	private Instr370 x6E_AW = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, false);
	...
	private Instr370 x6F_SW = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, true);
	...
	// STE - STORE (short)
	private Instr370 x70_STE = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
	...
	// LE - LOAD (short)
	private Instr370 x78_LE = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
	...
	// CE - COMPARE (short)
	private Instr370 x79_CE = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
	...
	private Instr370 x7A_AE = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, false);
	...
	private Instr370 x7B_SE = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, true);
	...
	private Instr370 x7C_ME = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			allowSignificance &= f1.isZero;
			f1.multiply(this.floatImpl.temp);
	...
	// DE - DIVIDE (short)
	private Instr370 x7D_DE = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			if (this.floatImpl.temp.isZero) { return INTR_PGM_FLOAT_DIVIDE; }
			allowSignificance &= f1.isZero;
	...
	private Instr370 x7E_AU = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, false);
	...
	private Instr370 x7F_SU = (ib2, ib3, ib4, ib5, ib6, updPSW) -> this.fpRX(ib2,  ib3,  ib4,  updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, true);
	...
	// DIAG - Diagnose
	private Instr370 x83_DIAG = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// WRD - Write Direct
	private Instr370 x84_WRD = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// RDD - Read Direct
	private Instr370 x85_RRD = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// SIO - Start IO (fast)
	private Instr370 x9C_SIO = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// TIO - Test IO 
	private Instr370 x9D_TIO = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// HIO - Halt IO
	private Instr370 x9E_HIO = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// TCH - Test channel
	private Instr370 x9F_TCH = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	private Instr370 xB1_LRA = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// STCTL - Store Control
	private Instr370 xB6_STCTL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// LCTL - Load Control
	private Instr370 xB7_LCTL = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	private Instr370 xAE_SIGP = (ib2, ib3, ib4, ib5, ib6, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	public int execInstruction(int exAt) throws PSWException {
		...
		int res = this.instructions[instr].execute(instrByte2, this.mem[at+2], this.mem[at+3], this.mem[at+4], this.mem[at+5], notEX);
