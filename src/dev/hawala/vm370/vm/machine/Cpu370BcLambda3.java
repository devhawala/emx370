...
/**
 * Third Java8-compatible implementation of S/370 instructions using
 * function pointers.
 * <br/>
 * The function interface is similar to one of {@link Cpu370BcLambda2}, extending
 * it with passing the memory {@code byte[]}-array in an attempt to speed up
 * access to the CPUs main memory.
 * <br/>
 ...
 */
public class Cpu370BcLambda3 extends Cpu370Bc {
	...
	public interface Instr370 {
		 ...
		 *
		 * @param cmem
		 * 		the main memory byte array of the CPU executing this
		 * 		instruction.
		 * @param at
		 ...
		 */
		public int execute(byte[] cmem, int at, byte ib2, boolean updPSW) throws PSWException;
	 ...
	 */
	private Instr370 invInstr = (cmem, at, ib2, updPSW) -> EXECSTATE_UNKNOWN_INSTRUCTION;
	...
	private Instr370 tmplRR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x04_SPM = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int op1 = this.gpr[r1];
	...
	private Instr370 x05_BALR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	private Instr370 x06_BCTR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x07_BCR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	// SSK - Set Storage Key
	private Instr370 x08_SSK = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
	...
	private Instr370 x09_ISK = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	// SVC - Supervisor call
	private Instr370 x0A_SVC = (cmem, at, ib2, updPSW) -> {		
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 2;
			this.pswInstructionLengthCode = 1;
...
//		}
	...
	private Instr370 x0B_BSM = (cmem, at, ib2, updPSW) -> {		
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 2;
			this.pswInstructionLengthCode = 1;
	...
	// 31-bit capable software
	// => tell the program that this is "old" hardware 
	private Instr370 x0C_BASSM = (cmem, at, ib2, updPSW) -> {		
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 2;
			this.pswInstructionLengthCode = 1;
	...
	private Instr370 x0D_BASM = (cmem, at, ib2, updPSW) -> {
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 2;
			this.pswInstructionLengthCode = 1;
	...
	private Instr370 x0E_MVCL = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
	...
	private Instr370 x0F_CLCL = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		...
		while(len1 > 0 && len2 > 0 && newCC < 0) {
			int b1 = cmem[addr1] & 0xFF;
			int b2 = cmem[addr2] & 0xFF;
	...
	// LPR - Load positive
	private Instr370 x10_LPR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	// LNR - Load negative
	private Instr370 x11_LNR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	private Instr370 x12_LTR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	private Instr370 x13_LCR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	// NR - And registers
	private Instr370 x14_NR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x15_CLR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	// OR - Or registers
	private Instr370 x16_OR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x17_XR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	// LR - Load register
	private Instr370 x18_LR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op2 = this.gpr[r2];
	...
	private Instr370 x19_CR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	// AR - Add registers
	private Instr370 x1A_AR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x1B_SR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x1C_MR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	// DR - Divide Registers
	private Instr370 x1D_DR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x1E_ALR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	private Instr370 x1F_SLR = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r2 = ib2 & 0x0F;
		int op1 = this.gpr[r1];
		int op2 = this.gpr[r2];
	...
	@SuppressWarnings("unused")
	private Instr370 tmplRX = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	// STH - Store halfword
	private Instr370 x40_STH = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		...
		// STH - Store halfword
		cmem[addr2++] = (byte)((op1 & 0xFF00) >> 8);
		cmem[addr2] = (byte)(op1 & 0xFF);
		return 0; // ok
	};
	
	// LA - Load address
	private Instr370 x41_LA = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// STC - Store character
	private Instr370 x42_STC = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// IC - Insert character
	private Instr370 x43_IC = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		...
		// IC - Insert character
		this.gpr[r1] = (op1 & 0xFFFFFF00) | (cmem[addr2] & 0xFF);
		return 0; // ok
	};
	
	// EX - Execute
	private Instr370 x44_EX = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		...
		if (cmem[addr2] == (byte)0x44) {
			this.doProgramInterrupt(INTR_PGM_EXECUTE_EXCEPTION);
			return 0; // ok
		}
		byte newByte2 = (r1 == 0) ? cmem[addr2+1] : (byte)(cmem[addr2+1] | (op1 & 0xFF));
	...
	// BAL - Branch and link
	private Instr370 x45_BAL = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// BCT - Branch on count
	private Instr370 x46_BCT = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 x47_BC = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// LH - Load halfword
	private Instr370 x48_LH = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		...
		// LH - Load halfword
		short op2 = (short)(((cmem[addr2]&0xFF)<<8) | (cmem[addr2+1]&0xFF));
		this.gpr[r1] = op2;
		return 0; // ok
	};
	
	// CH - Compare halfword
	private Instr370 x49_CH = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// AH - Add halfword
	private Instr370 x4A_AH = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 x4B_SH = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 x4C_MH = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// 31-bit capable software
	// => tell the program that this is "old" hardware 
	private Instr370 x4D_BAS = (cmem, at, ib2, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	private Instr370 x4E_CVD = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 x4F_CVB = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// ST - Store
	private Instr370 x50_ST = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		...
		// ST - Store
		cmem[addr2++] = (byte)((op1 >> 24) & 0xFF);
		cmem[addr2++] = (byte)((op1 >> 16) & 0xFF);
		cmem[addr2++] = (byte)((op1 >> 8) & 0xFF);
		cmem[addr2] = (byte)(op1 & 0xFF);
		return 0; // ok
	};
	
	// N - And
	private Instr370 x54_N = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		...
		// N - And
		int op2 = ((cmem[addr2]&0xFF)<<24) | ((cmem[addr2+1]&0xFF)<<16) | ((cmem[addr2+2]&0xFF)<<8) | (cmem[addr2+3]&0xFF);
		int res = op1 & op2;
		this.gpr[r1] = res;
		this.pswConditionCode= (res == 0) ? CC0 : CC1;
		return 0;
	...
	// CL - Compare logical
	private Instr370 x55_CL = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// O - Or
	private Instr370 x56_O = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// X - Exclusive or
	private Instr370 x57_X = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// L - Load
	private Instr370 x58_L = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// C - Compare
	private Instr370 x59_C = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// A - Add
	private Instr370 x5A_A = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// S - Substract
	private Instr370 x5B_S = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// M - Multiply
	private Instr370 x5C_M = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// D - Divide
	private Instr370 x5D_D = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	// AL - Add logical
	private Instr370 x5E_AL = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 x5F_SL = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int x2 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	@SuppressWarnings("unused")
	private Instr370 tmplRS = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 x80_SSM = (cmem, at, ib2, updPSW) -> {
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	private Instr370 x82_LPSW = (cmem, at, ib2, updPSW) -> {
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
...
//		if (INSNS_LOG) { this.checkSVC202end(); }
	...
	private Instr370 x86_BXH = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 x87_BXLE = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 x88_SRL = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 x89_SLL = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 x8A_SRA = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 x8B_SLA = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 x8C_SRDL = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 x8D_SLDL = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 x8E_SRDA = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 x8F_SLDA = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	// STM - Store Multiple
	private Instr370 x90_STM = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		...
		while(true) {
			...
			cmem[addr2++] = (byte)((val >> 24) & 0xFF);
			cmem[addr2++] = (byte)((val >> 16) & 0xFF);
			cmem[addr2++] = (byte)((val >> 8) & 0xFF);
			cmem[addr2++] = (byte)(val & 0xFF);
			addr2 &= MemMask;
			if (curr == r3) { break; }
			curr++;
			if (curr >= 16) { curr = 0; }
	...
	// LM - Load multiple
	private Instr370 x98_LM = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		...
		int curr = r1;
		while(true) {
			this.gpr[curr] = ((cmem[addr2]&0xFF)<<24) | ((cmem[addr2+1]&0xFF)<<16) | ((cmem[addr2+2]&0xFF)<<8) | (cmem[addr2+3]&0xFF);
	...
	private Instr370 xB2_PrivInstr = (cmem, at, ib2, updPSW) -> {
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		int ddd2 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	// CS - Compare and swap
	private Instr370 xBA_CS = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 xBB_CDS = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		...
		int op2a = ((cmem[addr2]&0xFF)<<24) | ((cmem[addr2+1]&0xFF)<<16) | ((cmem[addr2+2]&0xFF)<<8) | (cmem[addr2+3]&0xFF);
		int op2b = ((cmem[addr2+4]&0xFF)<<24) | ((cmem[addr2+5]&0xFF)<<16) | ((cmem[addr2+6]&0xFF)<<8) | (cmem[addr2+7]&0xFF);
	...
	private Instr370 xBD_CLM = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 xBE_STCM = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
		...
		// STCM - Store characters under mask
		int val = this.gpr[r1];
		if ((r3 & 0x08) != 0) { cmem[addr2++] = (byte)((val >> 24) & 0xFF); }
		if ((r3 & 0x04) != 0) { cmem[addr2++] = (byte)((val >> 16) & 0xFF); }
		if ((r3 & 0x02) != 0) { cmem[addr2++] = (byte)((val >> 8) & 0xFF); }
		if ((r3 & 0x01) != 0) { cmem[addr2++] = (byte)(val & 0xFF); }
		return 0; // ok
	};
	
	// ICM - Insert character under mask (r3 => mask)
	private Instr370 xBF_ICM = (cmem, at, ib2, updPSW) -> {
		int r1 = (ib2 & 0xF0) >> 4;
		int r3 = ib2 & 0x0F;
		byte ib3 = cmem[at+2];
		int b2 = (ib3 & 0xF0) >> 4;
	...
	@SuppressWarnings("unused")
	private Instr370 tmplSI = (cmem, at, ib2, updPSW) -> {
		int i2 = ib2 & 0xFF;
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	// TM - Test under Mask
	private Instr370 x91_TM = (cmem, at, ib2, updPSW) -> {
		int i2 = ib2 & 0xFF;
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
		...
		// TM - Test under Mask
		byte testedBits = (byte)(cmem[addr1] & (byte)i2);
	...
	// MVI - Move immediate
	private Instr370 x92_MVI = (cmem, at, ib2, updPSW) -> {
		int i2 = ib2 & 0xFF;
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	// TS - Test and set
	private Instr370 x93_TS = (cmem, at, ib2, updPSW) -> {
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
		int addr1 = (ddd1 + ((b1 == 0) ? 0 : this.gpr[b1])) & MemMask;
		...
		this.pswConditionCode = ((cmem[addr1] & (byte)0x80) != 0) ? CC1 : CC0;
		cmem[addr1] = (byte)0xFF;
		return 0; // ok
	};
	
	// NI - And immediate
	private Instr370 x94_NI = (cmem, at, ib2, updPSW) -> {
		int i2 = ib2 & 0xFF;
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 x95_CLI = (cmem, at, ib2, updPSW) -> {
		int i2 = ib2 & 0xFF;
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	// OI - Or immediate
	private Instr370 x96_OI = (cmem, at, ib2, updPSW) -> {
		int i2 = ib2 & 0xFF;
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 x97_XI = (cmem, at, ib2, updPSW) -> {
		int i2 = ib2 & 0xFF;
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 xAC_STNSM = (cmem, at, ib2, updPSW) -> {
		int i2 = ib2 & 0xFF;
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
		...
		// STNSM - Store Then AND System Mask
		cmem[addr1] = this.pswIntrMaskByte;
	...
	private Instr370 xAD_STOSM = (cmem, at, ib2, updPSW) -> {
		int i2 = ib2 & 0xFF;
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	@SuppressWarnings("unused")
	private Instr370 tmplSS = (cmem, at, ib2, updPSW) -> {
		...
		byte ib5 = cmem[at+4];
		int b2 = (ib5 & 0xF0) >> 4;
		int ddd2 = ((ib5 & 0x0F) << 8) + (cmem[at+5] & 0x00FF);
		int addr2 = (ddd2 + ((b2 == 0) ? 0 : this.gpr[b2])) & MemMask;
	...
	// MVN - Move numerics
	private Instr370 xD1_MVN = (cmem, at, ib2, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
		...
		// MVN - Move numerics
		while(ll-- > 0) {
			byte b = (byte)(cmem[addr1] & (byte)0xF0);
			cmem[addr1++] = (byte)((cmem[addr2++] & 0x0F) | b); 
		}
		return 0; // ok
	};
	
	// MVC - Move characters
	private Instr370 xD2_MVC = (cmem, at, ib2, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
		...
		// MVC - Move characters
		while(ll-- > 0) {
			cmem[addr1++] = cmem[addr2++]; 
		}
		return 0; // ok
	};
	
	// MVZ - Move zones
	private Instr370 xD3_MVZ = (cmem, at, ib2, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
		...
		// MVZ - Move zones
		while(ll-- > 0) {
			byte b = (byte)(cmem[addr1] & (byte)0x0F);
			cmem[addr1++] = (byte)((cmem[addr2++] & 0xF0) | b); 
		}
		return 0; // ok
	};
	
	// NC - And characters
	private Instr370 xD4_NC = (cmem, at, ib2, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 xD5_CLC = (cmem, at, ib2, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	// OC - Or characters
	private Instr370 xD6_OC = (cmem, at, ib2, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 xD7_XC = (cmem, at, ib2, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	// TR - Translate
	private Instr370 xDC_TR = (cmem, at, ib2, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
		...
		for (int i = 0; i < ll; i++) {
			...
			int src = cmem[a1] & 0xFF;
			cmem[a1] = cmem[(addr2 + src) & MemMask];
		}
		return 0;
	};
	
	// TRT - Translate and Test
	private Instr370 xDD_TRT = (cmem, at, ib2, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
		...
		while (i < ll) {
			int a1 = (addr1 + i++) & MemMask;
			int src = cmem[a1] & 0xFF;
			byte fnCode = cmem[(addr2 + src) & MemMask];
			if (fnCode != 0) {
	...
	// ED - Edit
	private Instr370 xDE_ED = (cmem, at, ib2, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	// EDMK - Edit and mark
	private Instr370 xDF_EDMK = (cmem, at, ib2, updPSW) -> {
		int ll = (ib2 & 0xFF) + 1; // 1..256
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
		int ddd1 = ((ib3 & 0x0F) << 8) | (cmem[at+3] & 0x00FF);
	...
	private Instr370 xF0_SRP = (cmem, at, ib2, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 xF1_MVO = (cmem, at, ib2, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
	...
	// PACK - Pack
	private Instr370 xF2_PACK = (cmem, at, ib2, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
	...
	// UNPK - Unpack
	private Instr370 xF3_UNPK = (cmem, at, ib2, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
	...
	// ZAP - Zero add packed
	private Instr370 xF8_ZAP = (cmem, at, ib2, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 xF9_CP = (cmem, at, ib2, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 xFA_AP = (cmem, at, ib2, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 xFB_SP = (cmem, at, ib2, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 xFC_MP = (cmem, at, ib2, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
	...
	// DP - Divide packed
	private Instr370 xFD_DP = (cmem, at, ib2, updPSW) -> {
		int l1 = ((ib2 & 0xF0) >> 4) + 1; // 1..16
		int l2 = (ib2 & 0x0F) + 1; // 1..16
		byte ib3 = cmem[at+2];
		int b1 = (ib3 & 0xF0) >> 4;
	...
	private Instr370 x20_LPDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
	...
	private Instr370 x21_LNDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			f1.isPositive = false;
	...
	private Instr370 x22_LTDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
	...
	private Instr370 x23_LCDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
	...
	// HDR - HALVE (long)
	private Instr370 x24_HDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.halveFrom(f2);
	...
	private Instr370 x25_LRDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installe
		});
	
	// MXR - MULTIPLY (extended)
	private Instr370 x26_MXR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installed
		});
	
	// MXDR - MULTIPLY (long to extended)
	private Instr370 x27_MXDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installed
		});
	
	// LDR - LOAD (long)
	private Instr370 x28_LDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			return oldCC;
		});
	...
	// CDR - COMPARE (long)
	private Instr370 x29_CDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return FloatImpl.CMP2CC[f1.compareWith(f2) + 1];
		});
	
	// ADR - ADD NORMALIZED (long)
	private Instr370 x2A_ADR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
	...
	private Instr370 x2B_SDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
	...
	// MDR - MULTIPLY (long)
	private Instr370 x2C_MDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.multiply(f2);
			return FloatImpl.generateResult(oldCC, f1, allowUnderflow, allowSignificance);
	...
	// DDR - DIVIDE (long)
	private Instr370 x2D_DDR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
	...
	private Instr370 x2E_AWR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, false);
	...
	private Instr370 x2F_SWR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, true);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), false, allowSignificance);
	...
	private Instr370 x30_LPER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			f1.isPositive = true;
			return (f1.isZero) ? 0 : 2;
	...
	private Instr370 x31_LNER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			f1.isPositive = false;
			return (f1.isZero) ? 0 : 1;
	...
	private Instr370 x32_LTER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), allowUnderflow, allowSignificance);
		});
	...
	private Instr370 x33_LCER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			f1.isPositive = !f1.isPositive;
			return FloatImpl.generateResult(oldCC, f1, f1.test(), allowUnderflow, false);
	...
	// HER - HALVE (short)
	private Instr370 x34_HER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.halveFrom(f2);
			return FloatImpl.generateResult(oldCC, f1, allowUnderflow, allowSignificance);
		});
	...
	private Instr370 x35_LRER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.halveFrom(f2);
			f1.roundToShort();
	...
	private Instr370 x36_AXR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installed
		});
	
	// SXR - SUBTRACT NORMALIZED (extended)
	private Instr370 x37_SXR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installed
		});
	
	// LER - LOAD (short)
	private Instr370 x38_LER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			f1.setFrom(f2);
			return oldCC;
		});
	...
	// CER - COMPARE (short)
	private Instr370 x39_CER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			return FloatImpl.CMP2CC[f1.compareWith(f2) + 1];
		});
	
	// AER - ADD NORMALIZED (short)
	private Instr370 x3A_AER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, false);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), allowUnderflow, allowSignificance);
	...
	private Instr370 x3B_SER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, true);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), allowUnderflow, allowSignificance);
	...
	private Instr370 x3C_MER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.multiply(f2);
			return FloatImpl.generateResult(oldCC, f1, allowUnderflow, allowSignificance);
	...
	// DER - DIVIDE (short)
	private Instr370 x3D_DER = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			if (f2.isZero) { return INTR_PGM_FLOAT_DIVIDE; }
			allowSignificance &= f1.isZero;
			f1.divide(f2);
	...
	private Instr370 x3E_AUR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, false);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), false, allowSignificance);
	...
	private Instr370 x3F_SUR = (cmem, at, ib2, updPSW) -> this.fpRR(ib2, updPSW,
		(oldCC, f1, f2, allowUnderflow, allowSignificance) -> {
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(f2, true);
			return FloatImpl.generateResult(oldCC, f1, f1.test(), false, allowSignificance);
	...
	// STD - STORE (long)
	private Instr370 x60_STD = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
	...
	private Instr370 x67_XD = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			return INTR_PGM_OPERATION_EXCEPTION; // Feature "extended floating-point" not installed
		});
	
	// LD - LOAD (long)
	private Instr370 x68_LD = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
	...
	// CD - COMPARE (long)
	private Instr370 x69_CD = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
	...
	private Instr370 x6A_AD = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
			allowSignificance &= f1.isZero;
	...
	private Instr370 x6B_SD = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
			allowSignificance &= f1.isZero;
	...
	// MD - MULTIPLY (long)
	private Instr370 x6C_MD = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
			allowSignificance &= f1.isZero;
	...
	// DD - DIVIDE (long)
	private Instr370 x6D_DD = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
	...
	private Instr370 x6E_AW = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, false);
	...
	private Instr370 x6F_SW = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, true);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, true);
	...
	// STE - STORE (short)
	private Instr370 x70_STE = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
	...
	// LE - LOAD (short)
	private Instr370 x78_LE = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
	...
	// CE - COMPARE (short)
	private Instr370 x79_CE = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
	...
	private Instr370 x7A_AE = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, false);
	...
	private Instr370 x7B_SE = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, true);
	...
	private Instr370 x7C_ME = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			allowSignificance &= f1.isZero;
			f1.multiply(this.floatImpl.temp);
	...
	// DE - DIVIDE (short)
	private Instr370 x7D_DE = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			if (this.floatImpl.temp.isZero) { return INTR_PGM_FLOAT_DIVIDE; }
			allowSignificance &= f1.isZero;
	...
	private Instr370 x7E_AU = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, false);
	...
	private Instr370 x7F_SU = (cmem, at, ib2, updPSW) -> this.fpRX(at, ib2, updPSW, 
		(oldCC, f1, addr, allowUnderflow, allowSignificance) -> {
			this.floatImpl.temp.internalize(mem, addr, false);
			allowSignificance &= f1.isZero;
			f1.addOrSubtract(this.floatImpl.temp, true);
	...
	// DIAG - Diagnose
	private Instr370 x83_DIAG = (cmem, at, ib2, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// WRD - Write Direct
	private Instr370 x84_WRD = (cmem, at, ib2, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// RDD - Read Direct
	private Instr370 x85_RRD = (cmem, at, ib2, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// SIO - Start IO (fast)
	private Instr370 x9C_SIO = (cmem, at, ib2, updPSW) -> {
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// TIO - Test IO 
	private Instr370 x9D_TIO = (cmem, at, ib2, updPSW) -> {
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// HIO - Halt IO
	private Instr370 x9E_HIO = (cmem, at, ib2, updPSW) -> {
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// TCH - Test channel
	private Instr370 x9F_TCH = (cmem, at, ib2, updPSW) -> {
		// instruction length: 1 half-word
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	private Instr370 xB1_LRA = (cmem, at, ib2, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// STCTL - Store Control
	private Instr370 xB6_STCTL = (cmem, at, ib2, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	// LCTL - Load Control
	private Instr370 xB7_LCTL = (cmem, at, ib2, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	private Instr370 xAE_SIGP = (cmem, at, ib2, updPSW) -> {
		// instruction length: 2 half-words
		if (updPSW) {
			this.pswInstructionAddress += 4;
			this.pswInstructionLengthCode = 2;
	...
	public int execInstruction(int exAt) throws PSWException {
		...
		int res = this.instructions[instr].execute(this.mem, at, instrByte2, notEX);
