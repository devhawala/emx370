...
public class EbcdicHandler {
	...
	public EbcdicHandler appendUnicode(String unicodeString) {
		...
		if (this.currLength == ebcdicChars.length) {
			this.isoEquiv = unicodeString;
		} else {
			this.isoEquiv = null;
		}
		return this;
	...
	/**
	 * Append the Java (unicode) string resulting of the the formatted string with
	 * parameters to this instance.
	 *    
	 * @param unicodeFormat the format string with embedded printf substitution
	 * 		and formatting tokens.
	 * @param args the arguments for the place holders.
	 * @return this instance for function call chaining.
	 */
	public EbcdicHandler sprintfAppend(String unicodeFormat, Object... args) {
		String unicodeString = String.format(unicodeFormat, args);
		this.appendUnicode(unicodeString);
		return this;
	}
	
	/**
	 * Replace the content of this instance with the Java (unicode) string resulting of
	 * the the formatted string with parameters.
	 *    
	 * @param unicodeFormat the format string with embedded printf substitution
	 * 		and formatting tokens.
	 * @param args the arguments for the place holders.
	 * @return this instance for function call chaining.
	 */
	public EbcdicHandler sprintfReplace(String unicodeFormat, Object... args) {
		String unicodeString = String.format(unicodeFormat, args);
		this.reset().appendUnicode(unicodeString);
		return this;
	}
