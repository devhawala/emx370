...
public class ByteBuffer {
	 ...
	 */
	protected ByteBuffer ensureSpace(int minFree) {
		if (minFree < 1) { return this; }
	...
	/**
	 * Reserve space in the buffer, leaving the space uninitialized (unmodified). This
	 * is for use in combination with getRawBytes();
	 * 
	 * @param count the space length to reserve
	 * @return the starting offset in the buffer where the reserved space starts
	 */
	public int reserveSpace(int count) {
		int startPoint = this.length;
